#include <stdio.h> 
/* Spa. 
El programa, al recibir como datos el tipo de tratamiento, la edad y el numero de dias internacion de un cliente en un spa, calcula el costo total del tratamiento.
...
int TRA, EDA, DIA;
float COS;
printf("Ingrese tipo de tratameinto, edad y dias: ");
