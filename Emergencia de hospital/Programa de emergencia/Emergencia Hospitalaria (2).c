...
int main() {
    ...
    printf("3. ¿Cuál es su síntoma tienes? ");
    ...
    } else if (strcmp(respuestas[2], "sangrado excesivo\n") == 0) {
        strcpy(procedimiento, "Aplicar presión directa y buscar atención médica urgente.");
    } else if (strcmp(respuestas[2], "confusión repentina\n") == 0) {
        strcpy(procedimiento, "Llamar al equipo de emergencia y mantener a la persona calmada.");
    } else {
