...
/* Cuenta cadenas. 
El programa, al recibir dos cadenas de carcteres, calcula e imprime cuantas veces se encuentra la segunda cadena en la primera. */

int main(void)
{
char cad1[50], cad2[50], *cad0= "";
int i = 0;
printf("\n INgresa la primera cadena de carcteres: ");
gets(cad1);
...
printf("\nEl numero de veces que parece la segunda cadena es: %d", i);
}
